...
describe('"collapse-indirect-recursion" transform', function () {
  ...
  describe('big indirect combined implementation', function () {
    ...
    const {
      ...
      B[file:b][line:10] B[file:b][line:10] B[file:b][line:10]  B[file:b][line:10]  B[file:b][line:18]  F[file:f][line:50]
      G[file:g][line:17] G[file:g][line:17] G[file:g][line:17]  G[file:g][line:17]  E[file:e][line:40]
      B[file:b][line:12] B[file:b][line:12] B[file:b][line:12]  D[file:d][line:30]
      X[file:x][line:60] X[file:x][line:60] X[file:x][line:60]
      Y[file:y][line:70] Y[file:y][line:70] Z[file:z][line:80]
      B[file:b][line:15] W[file:w][line:90]
      B[file:b][line:15]
      C[file:c][line:20]
    `);
    const B = funcNames.indexOf('B');
    ...
    it('can update apply the transform to the selected CallNodePaths', function () {
      ...
      dispatch(
        changeSelectedCallNode(
          threadIndex,
          ['A', 'B', 'G', 'B', 'X', 'Y', 'B', 'B', 'C'].map((name) => funcNames.indexOf(name))
        )
      );
      dispatch(addTransformToStack(threadIndex, collapseIndirectRecursion));
      expect(
